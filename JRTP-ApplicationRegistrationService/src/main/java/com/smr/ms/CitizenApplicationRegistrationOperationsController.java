...
import com.smr.service.ICitizenApplicationRegistrationService;
	...
	public ResponseEntity<String> saveCitizenApplication(@RequestBody CitizenAppRegistrationInputs inputs){
		try {
			...
			if(appId>0)
				...
				return new ResponseEntity<String>("Invalid SSN or Citizen must belong to California state "+appId,HttpStatus.OK);
